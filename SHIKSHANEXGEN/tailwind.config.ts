  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        healthcare: { DEFAULT: "hsl(var(--healthcare))", foreground: "hsl(var(--healthcare-foreground))" },
        tech: { DEFAULT: "hsl(var(--tech))", foreground: "hsl(var(--tech-foreground))" },
        marketing: { DEFAULT: "hsl(var(--marketing))", foreground: "hsl(var(--marketing-foreground))" },
        design: { DEFAULT: "hsl(var(--design))", foreground: "hsl(var(--design-foreground))" },
        hr: { DEFAULT: "hsl(var(--hr))", foreground: "hsl(var(--hr-foreground))" },
